...
//                 />
//               ) : (
//                 <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-full bg-black text-white flex items-center justify-center text-3xl sm:text-4xl font-bold">
//                   {initials}
//                 </div>
//               )}
...
//               {/* Edit */}
//               <button
//                 className="w-full mt-6 px-5 py-3 bg-black text-white rounded-lg hover:bg-gray-800 transition font-medium"
//               >
//                 Edit Profile
//               </button>
//             </div>
